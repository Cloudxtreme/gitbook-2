...
Logging categories have their settings stored in the logsys\_categories table, but the categories are defined in [common/eqemu\_logsys.h](https://github.com/EQEmu/Server/blob/master/common/eqemu_logsys.h)
